...
<div class="flex md:h-20 w-full max-w-full bg-background border-b-2 border-slate-900 justify-center content-center">
    <a href="/bible"><div class="transition hover:transition md:h-20 md:w-20 hover:text-xl  text-white text-center flex flex-col justify-center content-center"><h1>bible</h1></div></a>
